...
export class BigqueryBridge implements Bridge {
  constructor(private readonly config: BigqueryBridgeConfig) {}

  async connect(): Promise<void> {
    // TODO: open connection / pool
    throw new Error('BigqueryBridge.connect() not yet implemented')
  }

  async read(target: string, _options?: ReadOptions): Promise<ReadResult> {
    // TODO: paginated read with cursor
    throw new Error('BigqueryBridge.read() not yet implemented')
  }

  async count(target: string): Promise<number> {
    // TODO: row count
    throw new Error('BigqueryBridge.count() not yet implemented')
  }
  ...
  async query(
    ...
    throw new Error('BigqueryBridge.query() not yet implemented')
  }

  async disconnect(): Promise<void> {
    // TODO: close connection / pool
    throw new Error('BigqueryBridge.disconnect() not yet implemented')
  }
}
